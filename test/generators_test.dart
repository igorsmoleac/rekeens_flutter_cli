...
void main() {
  ...
  test('FeatureGenerator creates feature structure', () async {
    ...
    try {
      final generator = FeatureGenerator(templatesRootOverride: projectRoot);
  ...
  test('ScreenGenerator creates screen file', () async {
    ...
    try {
      final featureGen = FeatureGenerator(templatesRootOverride: projectRoot);
      await featureGen.generate('auth');

      final screenGen = ScreenGenerator(templatesRootOverride: projectRoot);
  ...
  test('ModelGenerator creates model file', () async {
    ...
    try {
      ...
      final modelGen = ModelGenerator(templatesRootOverride: projectRoot);
